...
- [ladieslearningcode.com](http://ladieslearningcode.com/)
- [thewaltdisneycompany.com](https://thewaltdisneycompany.com/)
- [o.canada.com](http://o.canada.com/)
- [fastcampus.co.kr](http://www.fastcampus.co.kr/)
- [bloter.net](http://www.bloter.net/)
- [insightofgscaltex.com](http://www.insightofgscaltex.com/)
...
1. 글쓰기 (무엇을 쓸 것인가?)
1. 미디어 삽입 (성능 최적화, 접근성) | [tinyjpg.com](http://tinyjpg.com/)
1. 미디어 정렬 (왼쪽/가운데/오른쪽)
1. 링크 (외부 링크, 내부 페이지 링크)
1. 미디어 다운로드

-

#### 3-3. 카테고리/태그 with 포스트

1. 카테고리 추가 (하위 계층 구조 작성)
1. 카테고리/아카이브/태그
1. 위젯 (태그 클라우드)
1. 메뉴 추가 (하위 계층 구조)
...
#### 3-4. about 페이지 with 하이어라취(계층)/템플릿(형판(形板),견본)

1. Depth 1. 페이지 추가
1. Depth 2. 페이지 추가 (Depth 1. 페이지의 하위 계층)
1. 페이지 내비게이션
...
1. 정적 프론트 페이지(Static Front Page) 설정
1. 포스트 페이지(Posts Page) 설정